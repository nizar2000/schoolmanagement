  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      ...
      <SheetPrimitive.Close
        className="yesabsolute yesright-4 yestop-4 yesrounded-sm yesopacity-70 yesring-offset-background yestransition-opacity hover:yesopacity-100 focus:yesoutline-none focus:yesring-2 focus:yesring-ring focus:yesring-offset-2 disabled:yespointer-events-none data-[state=open]:yesbg-secondary">
